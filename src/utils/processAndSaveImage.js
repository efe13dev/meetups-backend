...
const uploadsPath = path.join(__dirname, '../../uploads', process.env.UPLOADS_DIR);
...
const processAndSaveImage = async (imageBuffer) => {
  ...
  // Si el width de la imagen es mayor que 1000px, la redimensionamos a 1000px de width
